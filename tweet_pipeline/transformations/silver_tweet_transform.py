...
dp.create_streaming_table(
    name="tweets_silver",
    comment="Silver layer with cleaned tweet text, extracted mentions, exploded rows, and parsed timestamps."
)
...
def silver_transform():
    return (
        ...
        .withColumn(
            "cleaned_text",
            trim(regexp_replace(col("text"), r"@\S+", ""))
        )
        .withColumn(
            "mentions",
